  ...
  <q-page class="flex-center q-pa-md">
    ...
    <div>
      <q-card flat class="q-pa-md">
        <div class="q-pt-sm">
          This article explains how to add a form to your app that will allow users to send an email with their comments
          or suggestions.
        </div>
        ...
        <div class="q-pt-sm">
          ...
          Please look at the <a href="https://www.emailjs.com/">emaijs</a> webpage for other options such as adding a
          captcha to prevent spam.
          I recommend that you <a
            href="https://accounts.google.com/signup/v2/webcreateaccount?flowName=GlifWebSignIn&flowEntry=SignUp"
            target="_blank" rel="noopener noreferrer"> create a gmail account</a> to use specifically for the email
          sender.
        </div>

        <div class="q-pt-sm">
          Note that this exercise is focused on the app. You should look at the instructions on the emailjs website
          explaining how to create and test a template, connect your email account etc.
        </div>
        <div class="q-pt-sm">
        ...
        <div class="q-pt-sm">
          ...
          Type "control c" (press the 'control' and 'c' keys at the same time) to exit the Quasar development
          environment.
          Then install the library by entering the following command:
        </div>
        <pre>npm install @emailjs/browser</pre>
        <div class="q-pt-sm">
          Assuming there are no errors, the library is now installed so relaunch the Quasar development environment by
          typing 'quasar dev'
        </div>
...
&lt;/script&gt;
        ...
        <div class="q-pt-sm">
          ...
          This is a simple html form with three fields (message, from_name and reply_to email address) and a 'Send'
          button.
...
&lt;/div&gt;
        ...
        <div class="q-py-sm">
          You can't send an email with this form but to see how it works, click the "Send Feedback" menu in the side
          menu.
        </div>
