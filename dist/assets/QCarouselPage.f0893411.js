import{y as o,o as r,d as f,g as t,w as s,m as T,h as _,as as g,i as y,F as v,M as l,c as e,f as S,a as n}from"./index.d0600fff.js";import{Q as d}from"./QPageSticky.3eaefd60.js";import{Q as V}from"./QCarouselSlide.e0fcf47e.js";import{Q as B}from"./QCarousel.9b8ee152.js";import{Q as w}from"./QImg.8af05b51.js";import{c as j}from"./copy-to-clipboard.7a0543b4.js";import{u as L}from"./use-quasar.57f4256d.js";import"./touch.70a9dd44.js";import"./selection.0f580cd2.js";import"./use-fullscreen.75f4fae1.js";const N=e("div",{class:"q-pa-md heading"},"Code",-1),z=e("div",{class:"q-px-md"}," Copy the code using the copy button on the right and paste it into your project. ",-1),F={class:"q-px-md"},I={class:"q-pa-md"},P={ref:"header",class:"text-center text-deep-purple-8 text-weight-medium full-width text-h6 q-pa-lg"},A=e("a",{href:"https://quasar.dev/vue-components/carousel"},"Q-Carousel ",-1),D={class:"text-grey-8 text-weight-medium full-width q-pa-md"},E=e("b",null,"animations : 'all'",-1),M={class:"q-pt-sm text-center"},O=e("br",null,null,-1),U=e("b",null,"fontawesome-v6",-1),W={class:"q-pt-sm"},se={__name:"QCarouselPage",setup($){const x=L(),c=o("slide1"),m=o(),i=o(!1),C=o(!1),q=o("Copy code"),p=o("info");function u(){console.log("Show code"),i.value=!i.value}const b=[{id:1,name:"slide1",src:"https://picsum.photos/800/600?random=1",text:"This is Slide 1"},{id:2,name:"slide2",src:"https://picsum.photos/800/600?random=2",text:"This is Slide 2"},{id:3,name:"slide3",src:"https://picsum.photos/800/600?random=3",text:"This is Slide 3"},{id:4,name:"slide4",src:"https://picsum.photos/800/600?random=4",text:"This is Slide 4"}];function Q(){x.platform.is.mac,confirm("This action might replace the contents of your clipboard.")&&j(m.value.textContent).then(()=>{C.value=!0,q.value="Copied",p.value="positive"}).catch(()=>{})}return(k,h)=>(r(),f(v,null,[t(T,{appear:"","enter-active-class":"animated slideInLeft",duration:1e3,"leave-active-class":"animated slideOutLeft"},{default:s(()=>[i.value?(r(),_(g,{key:0},{default:s(()=>[N,z,t(d,{class:"z-top",position:"top-right",offset:[20,20]},{default:s(()=>[t(l,{fab:"",icon:"fa-solid fa-images",color:"accent",onClick:u})]),_:1}),t(d,{class:"z-top",position:"top-right",offset:[80,20]},{default:s(()=>[t(l,{fab:"",icon:"fa fa-copy",color:p.value,onClick:Q},null,8,["color"])]),_:1}),e("div",F,[e("pre",{style:{"word-wrap":"break-word","white-space":"pre-wrap"},ref_key:"codeToCopy",ref:m},`<template>
 <q-carousel
    v-model="slide"
    animated
    arrows
