import { Q as d } from './QImg.8af05b51.js'; import { Q as n } from './QItemLabel.a843cfd3.js'; import { L as c, K as u, e as r, o as h, h as p, w as a, g as o, c as e, a as t, M as l, as as m } from './index.d0600fff.js'; import { Q as _ } from './QSpace.0fdd957d.js'; import { Q as b } from './QPage.98f2eec1.js'; import { S as f } from './SubHeaderComponentDA.5dfb713b.js'; import { c as g } from './copy-to-clipboard.7a0543b4.js'; import './use-quasar.57f4256d.js'; const y = u({ name: 'ProgrammingStartPage', components: { SubHeaderComponentDA: f } }); g('some text').then(() => {}).catch(() => {}); const w = e('div', { class: 'q-pa-md text-h5 header' }, 'Getting started with Quasar', -1), v = e('div', { class: 'q-pt-sm' }, ' The goal for this lesson is to get to this: ', -1), k = e('div', { class: 'q-pt-sm' }, ' This is the order of tasks. Although it might seem complicated, it should take no longer than 15 minutes (on Windows installing node.js can take longer). ', -1), q = { class: 'q-pt-sm' }, P = e('a', { href: 'https://code.visualstudio.com/download' }, [e('b', null, 'Download and install Visual Studio Code')], -1), S = e('a', { href: 'https://nodejs.org/en/download/' }, [e('b', null, 'Install node.js')], -1), C = e('b', null, 'LTS', -1), Q = e('b', null, 'Install Quasar CLI', -1), T = e('a', { href: 'https://www.lifewire.com/how-to-open-command-prompt-2618089' }, 'Command Prompt', -1), x = e('br', null, null, -1), I = e('br', null, null, -1), j = e('br', null, null, -1), A = e('br', null, null, -1), Y = e('pre', null, `dcs@Darrens-MacBook-Pro learn_quasar % \u25AF
`, -1), L = e('b', null, 'Return', -1), V = e('b', null, 'Enter', -1), M = e('pre', null, [t(''), e('span', { class: 'disable-select' }, '$ '), t(`npm i -g @quasar/cli
