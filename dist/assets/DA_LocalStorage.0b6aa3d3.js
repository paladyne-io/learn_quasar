import{o as d,q as h,t as u,x as m,D as e,d as r,C as l,z as t}from"./index.cab14eb4.js";import{Q as p}from"./QPage.a203f305.js";import{u as g}from"./use-quasar.bab3725f.js";const f=e("div",{class:"heading q-pa-md"},"Local Storage",-1),w=e("div",{class:"q-pa-md text-subheader text-center full-width"}," This article explains the basics of reading and writing (saving) data and how to use vue's lifecycle hooks. ",-1),_=e("div",{class:"q-pa-md"},[t(" Lifecycle hooks allow code to be run at certain times. For example, 'onMounted' is a special event that is called when a page loads. More information is "),e("a",{href:"https://vuejs.org/api/composition-api-lifecycle.html"},"here"),t(". "),e("p"),e("p"),t("This is simple example when using script setup... ")],-1),b=e("pre",null,`<script setup>
...
`,-1),k=e("div",{class:"q-pa-md"}," Notice the slightly different syntax, when getting data it is called 'getItem'. When saving or writing, it is just called 'set'. ",-1),I=e("div",{class:"q-pa-md text-center full-width"}," Next - connecting our 'getData' function to the table. ",-1),N={class:"text-center q-pa-md full-width"},L={class:"text-center q-pa-md"},A={__name:"DA_LocalStorage",setup(M){d(()=>{console.log("mounted");const a=n("name");if(console.log("Data: "+a),!a){i("name","George"),i("age","5");const o=n("name");console.log("Data: "+o)}});const s=g();function n(a){try{return s.localStorage.getItem(a)}catch(o){console.log("Error getting data: "+o)}}function i(a,o){try{s.localStorage.set(a,o)}catch(c){console.log("Error saving data: "+c)}}return(a,o)=>(h(),u(p,{class:"flex flex-center"},{default:m(()=>[f,w,_,b,v,y,x,q,D,S,Q,k,I,e("div",N,[r(l,{label:"Loading data to a table",color:"primary",to:"da_table"})]),e("div",L,[r(l,{label:"Home",color:"green",to:"/"})])]),_:1}))}};export{A as default};
