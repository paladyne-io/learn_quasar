import{Q as f}from"./QImg.682a12e9.js";import{Q as s}from"./QItemLabel.e3781dfe.js";import{Q as l}from"./QItem.1380bde4.js";import{Q as y}from"./QCard.dfe8825f.js";import{Q as g}from"./QPage.e84a87f1.js";import{_ as w,p as b,B as c,q as r,t as i,x as o,d as a,D as e,l as p,z as t,ae as u}from"./index.92565cc2.js";import{S as v}from"./SubHeaderComponentDA.04fbddc5.js";import"./use-dark.0cc6b9a0.js";import"./use-quasar.e02f954f.js";const k=b({name:"ProgrammingStartPage",components:{SubHeaderComponentDA:v}}),q=e("div",{class:"q-pa-md text-h5 text-bold"}," Programming Start",-1),P=e("div",{class:"q-pt-sm"}," Your mission today is to get to this: ",-1),S=e("div",{class:"q-pt-sm"}," This is the basic order of tasks (assuming you have a PC). ",-1),C={class:"q-pt-sm"},Q=t(" 1. "),I=e("a",{href:"https://code.visualstudio.com/download"},[e("b",null,"Download and install Visual Studio Code")],-1),x=t(" (Highly recommended) "),A=t(" 2. "),T=e("a",{href:"https://nodejs.org/en/download/"},[e("b",null,"Install node.js")],-1),Y=t(" * Download and run one of the "),j=e("b",null,"LTS",-1),V=t(" installers appropriate for your computer. "),$=t(" 3. "),D=e("b",null,"Install Quasar CLI and create your app",-1),L=t(". To do these steps you can use the Terminal application (Mac), "),M=e("a",{href:"https://www.lifewire.com/how-to-open-command-prompt-2618089"},"Command Prompt",-1),B=t(" or PowerShell (Windows), or the Terminal window in Visual Studio Code. If you have not used the Mac Terminal or Windows Command Prompt it might be better to try the Terminal window in Visual Studio Code first. "),E=t("Click here for details"),N=t(". The $ character represents the shell prompt. It might appear as a %. You enter commands after this symbol and press Return or Enter to run them. "),W=e("pre",null,`$ yarn global add @quasar/cli
$ yarn create quasar
...
`,-1),J=e("div",{class:"q-pt-sm"}," You can verify the current working directory by typing 'pwd' and change it by typing 'cd ' ('cd' followed by a space) and then the full path. An easy way to get the full path to a folder is to drag and drop the folder/directory on to the Terminal window after \u201Ccd \u201D. ",-1),K=e("div",{class:"q-pt-sm"},` In the directory/folder that you chose you will find a folder named after your app. This is your project folder. Open it in Visual Studio Code by choosing "Open folder\u2026" from the File menu. Another way is to type "code ." in the terminal after the the "Quasar \u2022 SUCCESS" message to open the working directory. If you have already entered 'quasar dev', hold down the "control" and "c" keys together to stop the program (exit the development environment). `,-1),X=e("div",{class:"q-pt-sm"},` The working directory will remain set until you close the Terminal window. If you ever see an error such as Unknown command "dev" when you enter 'quasar dev' it is probably because your working directory changed. `,-1),Z=e("div",{class:"q-pt-sm"},[t(" If you made it this far, pat yourself on the back, show your friend/partner, make a post on your social platform of choice and take a break to celebrate your progress. "),e("div",{class:"q-pt-sm"},"If something didn't work, drop a note in the comments* or email me at darren@paladyne.co.jp to get help. (* Comments are coming soon, in a later lesson. ) ")],-1),ee={class:"row text-subheader q-pt-sm"},te=t(" Previous "),oe=e("div",{style:{"text-align":"right"},class:"full-width"}," Next: Making it your own ",-1);function ae(d,n,ne,se,re,ie){const h=c("SubHeaderComponentDA"),m=c("router-link");return r(),i(g,{class:"flex-center q-pa-md"},{default:o(()=>[q,a(y,{flat:"",class:"q-pa-md"},{default:o(()=>[a(h,{mytext:"Getting started programming with Quasar (Preparation)"}),P,a(f,{src:"images/QuasarAppTopPage.png",alt:"MyApp menu screen"}),S,e("div",C,[a(s,null,{default:o(()=>[Q,I,x]),_:1}),a(s,{class:"q-pt-md"},{default:o(()=>[A,T,Y,j,V]),_:1}),a(s,{class:"q-pt-md"},{default:o(()=>[$,D,L,M,B,a(m,{to:"/vscodeterminal"},{default:o(()=>[E]),_:1}),N]),_:1}),W,a(s,{class:"q-pt-md"},{default:o(()=>[H]),_:1}),O,U,z,F,R,G,J,K,X,Z]),e("div",ee,[p((r(),i(l,{class:"col",clickable:"",to:"intro",onClick:n[0]||(n[0]=_=>d.link="intro")},{default:o(()=>[te]),_:1})),[[u]]),p((r(),i(l,{class:"col",clickable:"",to:"helloworld",onClick:n[1]||(n[1]=_=>d.link="helloworld")},{default:o(()=>[oe]),_:1})),[[u]])])]),_:1})]),_:1})}var ye=w(k,[["render",ae]]);export{ye as default};
