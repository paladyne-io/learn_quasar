...
`)],-1),W=e("div",{class:"q-pa-md"}," Notice the slightly different syntax, when getting data it is called 'getItem'. When saving or writing, it is just called 'set'. ",-1),M=e("div",{class:"q-pa-md text-center full-width"}," Coming soon - using an online database... ",-1),$={class:"text-center q-pa-md"},ee={__name:"DA_DataTable",setup(B){h(()=>{console.log("Mounted. Reading table data..."),d(),c(),console.log("Rows: "+t),console.log("Columns: "+s),console.log("Rows: "+JSON.stringify(t)),console.log("Columns: "+JSON.stringify(s))});const o=w();let s=[{name:"exercise",label:"Exercise",field:"exercise",align:"left"},{name:"time",label:"Time",field:"time"},{name:"calories",label:"Calories",field:"calories"}],t=[{exercise:"Walking",time:30,calories:100},{exercise:"Chasing cars",time:60,calories:400}];function c(){try{t=o.localStorage.getItem("rows"),s=o.localStorage.getItem("columns")}catch(n){console.log("Error reading data: "+n)}}function d(){console.log("saving TableData..."),console.log("Rows: "+t);try{o.localStorage.set("rows",t),o.localStorage.set("columns",s)}catch(n){console.log("Error saving data: "+n)}}return(n,P)=>(u(),g(b,{class:"flex flex-center"},{default:p(()=>[f,_,v,y,x,q,S,T,C,N,R,k,A,D,J,j,I,e("div",E,[l(m,{dense:"",title:"Data",rows:r(t),columns:r(s),"row-key":"name"},null,8,["rows","columns"])]),O,Q,W,M,e("div",$,[l(i,{class:"q-ma-sm",label:"Home",color:"green",to:"/"}),l(i,{class:"q-ma-sm",label:"Examples",color:"orange",to:"../examples/imagegrid"}),l(i,{class:"q-ma-sm",label:"Time for a  Game?",color:"blue",to:"../gameapp/rm_game/"})])]),_:1}))}};export{ee as default};
