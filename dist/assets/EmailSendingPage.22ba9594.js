...
`,-1),J={class:"q-pt-sm"},K=e("div",{class:"q-py-sm"},` You can't send an email with this form but to see how it works, click the "Send Feedback" menu in the side menu. `,-1),L={class:"row full-width text-subheader q-pt-sm"};function O(h,o,l,i,r,f){const s=q("UserContactComp");return u(),x(C,{class:"flex-center q-pa-md"},{default:p(()=>[Y,e("div",null,[a(k,{flat:"",class:"q-pa-md"},{default:p(()=>[P,Q,B,M,U,$,I,A,z,F,G,W,D,H,e("div",J,[t(" This will display like this: "),a(s)]),K,e("div",L,[a(c,{outline:"",style:{color:"goldenrod"},label:"Previous",to:"images"}),a(S),a(c,{outline:"",style:{color:"goldenrod","text-align":"right"},label:"Next: Build an app",to:"/dummyapp/"})])]),_:1})])]),_:1})}var ee=b(N,[["render",O]]);export{ee as default};
