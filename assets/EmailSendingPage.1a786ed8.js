...
`,-1),J={class:"q-pt-sm"},K=t(" This will display like this: "),L=t(` You can't send an email with this form but to see how it works, click the "Send Feedback" menu in the side menu. `),O={class:"row full-width text-subheader q-pt-sm"};function R(h,s,l,i,r,f){const o=x("UserContactComp");return u(),q(C,{class:"flex-center q-pa-md"},{default:p(()=>[Q,e("div",null,[a(S,{flat:"",class:"q-pa-md"},{default:p(()=>[Y,B,P,M,U,$,I,z,F,A,D,W,G,H,e("div",J,[K,a(o),L]),e("div",O,[a(c,{outline:"",style:{color:"goldenrod"},label:"Previous",to:"images"}),a(k),a(c,{outline:"",style:{color:"goldenrod","text-align":"right"},label:"Next: Build an app",to:"/dummyapp/"})])]),_:1})])]),_:1})}var re=b(V,[["render",R]]);export{re as default};
