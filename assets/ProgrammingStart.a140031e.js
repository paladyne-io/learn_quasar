import{Q as d}from"./QImg.83203848.js";import{Q as a}from"./QItemLabel.1ae0e09f.js";import{_ as c,p,B as n,q as h,t as u,x as s,d as o,D as e,C as r,z as t}from"./index.4d31a4bc.js";import{Q as _}from"./QSpace.c007ecdc.js";import{Q as m}from"./QCard.ca3ab117.js";import{Q as f}from"./QPage.0ba4fc9f.js";import{S as g}from"./SubHeaderComponentDA.b12fa164.js";import{c as y}from"./copy-to-clipboard.7a0543b4.js";import"./use-dark.c843e23f.js";import"./use-quasar.0d1bcba3.js";const b=p({name:"ProgrammingStartPage",components:{SubHeaderComponentDA:g}});y("some text").then(()=>{}).catch(()=>{});const w=e("div",{class:"q-pa-md text-h5 header"},"Getting started with Quasar",-1),v=e("div",{class:"q-pt-sm"}," The goal for this lesson is to get to this: ",-1),k=e("div",{class:"q-pt-sm"}," This is the order of tasks. ",-1),q={class:"q-pt-sm"},S=t(" 1. "),P=e("a",{href:"https://code.visualstudio.com/download"},[e("b",null,"Download and install Visual Studio Code")],-1),Q=t(" (Highly recommended) "),C=t(" 2. "),x=e("a",{href:"https://nodejs.org/en/download/"},[e("b",null,"Install node.js")],-1),I=t(" by downloading and running the "),T=e("b",null,"LTS",-1),j=t(" installer appropriate for your computer. "),A=t(" 3. "),Y=e("b",null,"Install Quasar CLI",-1),V=t(". To perform this and the following steps it is necessary to use the Terminal application (Mac) or the "),L=e("a",{href:"https://www.lifewire.com/how-to-open-command-prompt-2618089"},"Command Prompt",-1),$=t(" or PowerShell (Windows). "),M=e("br",null,null,-1),B=e("br",null,null,-1),D=t("If you have not used these applications before, I suggest you use the Terminal in Visual Studio Code. "),N=e("a",{href:"/vscodeterminal"},"Click here for details",-1),E=t(". "),H=e("br",null,null,-1),U=e("br",null,null,-1),W=t("The $ character represents the shell prompt. It might appear as a %. Type commands after this symbol and press "),z=e("b",null,"Return",-1),O=t(" or "),F=e("b",null,"Enter",-1),G=t(" \u23CE to run them. "),J=e("pre",null,[t(""),e("span",{class:"disable-select"},"$ "),t(`npm i -g @quasar/cli
`),e("span",{class:"disable-select"},"or"),t(`
`),e("span",{class:"disable-select"},"$ "),t(`yarn global add @quasar/cli
`)],-1),K=t(" *If you experience problems installing Quasar on a Mac, try installing Node using nvm (Node Version Manager). "),R=t("Click here for details"),X=t(". "),Z=e("div",{class:"q-pt-sm"}," 4. Use the Quasar CLI to create your app by entering one of the following commands in the terminal.",-1),ee=e("pre",null,[t(""),e("span",{class:"disable-select"},"$ "),t(`npm init quasar
`),e("span",{class:"disable-select"},"or"),t(`
...
`,-1),le=t(" 6. The current working directory can be changed by typing 'cd ' ('cd' followed by a space) and then the full path. An easy way to get the full path to a folder is to drag and drop the folder/directory onto the Terminal window after \u201Ccd \u201D. "),de=e("div",{class:"q-pt-sm"},` Open your project folder in Visual Studio Code by choosing "Open folder\u2026" from the File menu or by typing "code ." in the terminal after the "Quasar \u2022 SUCCESS" message. If you have already entered 'quasar dev', press the "control" and "c" keys together to stop the program (exit the development environment). `,-1),ce=e("div",{class:"q-pt-sm"},` The working directory will remain set until you close the Terminal window. If you ever see an error such as 'Unknown command "dev"' after entering 'quasar dev' it is probably because your working directory changed. `,-1),pe=e("div",{class:"q-pt-sm"},[t(" If you made it this far, pat yourself on the back, show your friend/partner, make a post on your social platform of choice and take a break to celebrate your progress. "),e("div",{class:"q-pt-sm"},[t("If something didn't work, please use the "),e("a",{href:"feedback"}," feedback form"),t(" to get help. ")])],-1),he={class:"row q-pt-md"},ue={class:"row full-width text-subheader q-pt-sm"};function _e(me,fe,ge,ye,be,we){const i=n("SubHeaderComponentDA"),l=n("router-link");return h(),u(f,{class:"flex-center q-pa-sm"},{default:s(()=>[w,o(m,{flat:"",class:"q-pa-md"},{default:s(()=>[o(i,{mytext:"Preparation"}),v,o(d,{src:"images/QuasarAppTopPage.png",alt:"MyApp menu screen"}),k,e("div",q,[o(a,null,{default:s(()=>[S,P,Q]),_:1}),o(a,{class:"q-pt-md"},{default:s(()=>[C,x,I,T,j,o(a,{class:"q-pt-md"},{default:s(()=>[A,Y,V,L,$,M,B,D,N,E,H,U,W,z,O,F,G]),_:1}),J,K,o(l,{to:"/nvm_install"},{default:s(()=>[R]),_:1}),X]),_:1}),Z,ee,te,oe,se,ae,ne,re,ie,le,de,ce,pe]),e("div",he,[e("div",ue,[o(r,{outline:"",style:{color:"goldenrod"},label:"Previous",to:"intro"}),o(_),o(r,{outline:"",style:{color:"goldenrod","text-align":"right"},label:" Next: Make it your own",to:"helloworld"})])])]),_:1})]),_:1})}var je=c(b,[["render",_e]]);export{je as default};
