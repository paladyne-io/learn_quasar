...
`,-1),de=t(" The current working directory can be changed by typing 'cd ' ('cd' followed by a space) and then the full path. An easy way to get the full path to a folder is to drag and drop the folder/directory onto the Terminal window after \u201Ccd \u201D. "),le=e("div",{class:"q-pt-sm"},` Open your project folder in Visual Studio Code by choosing "Open folder\u2026" from the File menu or by typing "code ." in the terminal after the "Quasar \u2022 SUCCESS" message. If you have already entered 'quasar dev', hold down the "control" and "c" keys together to stop the program (exit the development environment). `,-1),ce=e("div",{class:"q-pt-sm"},` The working directory will remain set until you close the Terminal window. If you ever see an error such as Unknown command "dev" when you enter 'quasar dev' it is probably because your working directory changed. `,-1),he={class:"q-pt-sm"},pe=t(" If you made it this far, pat yourself on the back, show your friend/partner, make a post on your social platform of choice and take a break to celebrate your progress. "),ue={class:"q-pt-sm"},me=t("If something didn't work, please use the "),_e=t(" feedback form"),fe=t(" to get help. "),ge={class:"row q-pt-md"},ye={class:"row full-width text-subheader q-pt-sm"};function be(we,ve,qe,ke,Se,Pe){const d=r("SubHeaderComponentDA"),a=r("router-link");return p(),u(f,{class:"flex-center q-pa-md"},{default:n(()=>[b,o(_,{flat:"",class:"q-pa-md"},{default:n(()=>[o(d,{mytext:"Getting started with Quasar (Preparation)"}),w,o(l,{src:"images/QuasarAppTopPage.png",alt:"MyApp menu screen"}),v,e("div",q,[o(s,null,{default:n(()=>[k,S,P]),_:1}),o(s,{class:"q-pt-md"},{default:n(()=>[C,Q,x,I,T,o(s,{class:"q-pt-md"},{default:n(()=>[V,Y,j,A,L,M,N,$,B,D,o(a,{to:"/vscodeterminal"},{default:n(()=>[E]),_:1}),U,W,z,H,O,F,G,J]),_:1}),K,R]),_:1}),X,Z,ee,te,oe,ne,se,ae,re,ie,de,le,ce,e("div",he,[pe,e("div",ue,[me,o(a,{to:"feedback"},{default:n(()=>[_e]),_:1}),fe])])]),e("div",ge,[e("div",ye,[o(i,{outline:"",style:{color:"goldenrod"},label:"Previous",to:"intro"}),o(m),o(i,{outline:"",style:{color:"goldenrod","text-align":"right"},label:" Next: Making it your own",to:"helloworld"})])])]),_:1})]),_:1})}var Le=c(y,[["render",be]]);export{Le as default};
